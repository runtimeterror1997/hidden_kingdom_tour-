...
interface KnowBhutanDetailProps {
  title: string;
  subtitle: string;
  heroImage: string;
...
export function KnowBhutanDetail({
  title,
  subtitle,
  heroImage,
  children,
}: KnowBhutanDetailProps) {
  return (
    <div className="min-h-screen pt-0 pb-14 bg-zinc-50 dark:bg-black">
      {/* Hero Section */}
      <section className="relative h-[60vh] min-h-[500px] pt-32 flex flex-col items-center justify-center">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center justify-center pt-32 text-center">
