        ...
        <div className="hidden lg:flex flex-col gap-4 relative">
          ...
          <div className={cn(
            ...
            isScrolled ? "pb-2 border-zinc-200/50" : "pb-4 border-white/10"
             ...
             {/* Right: Socials */}
             <div className="flex-1 flex items-center justify-end gap-4 uppercase transition-all duration-500">
                <a target="_blank" href="https://www.facebook.com/people/Oasis-tour-and-trek/61586763656788/" className={cn(
                  "p-1.5 rounded-full transition-all",
                  isScrolled ? "bg-zinc-100 text-zinc-500 hover:text-primary" : "bg-white/5 text-white/50 hover:text-white"
                )}>
                ...
                <a target="_blank" href="https://www.instagram.com/oasistoursandtreks_?igsh=MXJtM2ttajRxOGF3Nw==" className={cn(
                  "p-1.5 rounded-full transition-all",
                  isScrolled ? "bg-zinc-100 text-zinc-500 hover:text-primary" : "bg-white/5 text-white/50 hover:text-white"
                )}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-3.5 h-3.5">
                 ...
                 <a target="_blank" href="https://www.tiktok.com/@touragent2?_r=1&_t=ZS-93G2CHp1uTQ" className={cn(
                  "p-1.5 rounded-full transition-all",
                  isScrolled ? "bg-zinc-100 text-zinc-500 hover:text-primary" : "bg-white/5 text-white/50 hover:text-white"
                )}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="none" className="w-3.5 h-3.5">
