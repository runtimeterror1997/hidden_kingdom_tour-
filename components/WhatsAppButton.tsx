    ...
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      >
        ...
        <Button 
          size="icon" 
          className={cn(
            "h-12 w-12 rounded-full bg-[#25D366] hover:bg-[#20bd5a] shadow-lg transition-all duration-300 hover:scale-110 relative",
            "flex items-center justify-center shadow-[#25D366]/20 hover:shadow-[#25D366]/40",
            "after:absolute after:inset-0 after:rounded-full after:bg-[#25D366]/40 after:animate-ping after:scale-110 after:-z-10 group-hover:after:hidden"
          )}
        >
          {/* WhatsApp SVG Icon */}
          <svg 
